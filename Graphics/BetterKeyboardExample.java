...
public class BetterKeyboardExample extends JPanel implements KeyListener
{
  ...
  //making buttons to change the color of the squares
  //there will be a button for each color
  //there will be two rows of buttons, one for each square
  //the buttons will be in the top left corner of the screen
  public void colorChange() {
  // Create color buttons for ourSquare
  JButton redButton = new JButton("Red");
  redButton.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent e) {
      ourSquare.setColor(Color.RED);
    }
  });
  ...
  greenButton.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent e) {
      ourSquare.setColor(Color.GREEN);
    }
  });
  ...
  blueButton.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent e) {
      ourSquare.setColor(Color.BLUE);
    }
  });

  // Create color buttons for theirSquare
  JButton yellowButton = new JButton("Yellow");
  yellowButton.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent e) {
      theirSquare.setColor(Color.YELLOW);
    }
  });
  ...
  magentaButton.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent e) {
      theirSquare.setColor(Color.MAGENTA);
    }
  });
  ...
  cyanButton.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent e) {
      theirSquare.setColor(Color.CYAN);
    }
  });
  ...
  public void keyPressed(KeyEvent e)
  {
    ...
    //making theirSquare move with the WASD keys
