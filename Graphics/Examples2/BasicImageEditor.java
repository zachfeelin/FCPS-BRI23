...
public class BasicImageEditor extends JPanel implements MouseListener
{
  ...
  public void mousePressed(MouseEvent e)
  {
    ...
    if(button == MouseEvent.BUTTON3){
      ...
      else if(brushColor == Color.ORANGE){
        brushColor = Color.YELLOW;
      }
      else if(brushColor == Color.YELLOW){
      ...
      else if(brushColor == Color.CYAN){
        brushColor = Color.MAGENTA;
      }
      else if(brushColor == Color.MAGENTA){
        brushColor = Color.PINK;
      }
      else if(brushColor == Color.PINK){
        brushColor = Color.WHITE;
      }
      else if(brushColor == Color.WHITE){
        brushColor = Color.BLACK;
      }
      else if(brushColor == Color.BLACK){
